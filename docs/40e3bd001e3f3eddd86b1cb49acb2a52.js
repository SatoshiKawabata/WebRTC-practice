...
},{"./runtime":18}],14:[function(require,module,exports) {
module.exports = require("regenerator-runtime");

},{"regenerator-runtime":16}],12:[function(require,module,exports) {
"use strict";
...
var actions = {
  ...
  connect: function connect() {
    return function (state, actions) {
      ...
      // offerを作成する
      peer.createOffer(MEDIA_CONST).then(function (sd) {
  ...
  setSelfSDP: function setSelfSDP(selfSDP) {
    return function (state) {
      state.peer.setLocalDescription(selfSDP);
      return { selfSDP: selfSDP };
    };
  },
  ...
  onReceivePartnerSDP: function onReceivePartnerSDP(e) {
    return function (state, actions) {
      var partnerSDP = JSON.parse(e.target.value);
      return { partnerSDP: partnerSDP };
    };
  },

  setPartnerSDP: function setPartnerSDP() {
    return function (state, actions) {
      var partnerSDP = state.partnerSDP;
      var peer = state.peer;
      ...
      if (peer) {
        ...
        peer.setRemoteDescription(new RTCSessionDescription(partnerSDP));
        peer.createAnswer(MEDIA_CONST).then(function (selfSDP) {
          actions.setSelfSDP(selfSDP);
        });
      }
      return { partnerSDP: partnerSDP, peer: peer };
    };
  },

  setSelfICE: function setSelfICE(selfICE) {
    return function (state) {
  ...
  onReceivePartnerICE: function onReceivePartnerICE(e) {
    return function (state, actions) {
      var partnerICEs = JSON.parse(e.target.value);
      return { partnerICEs: partnerICEs };
    };
  },

  setPartnerICE: function setPartnerICE() {
    return function (state, actions) {
      var partnerICEs = state.partnerICEs,
          peer = state.peer;

      partnerICEs.forEach(function (ice) {
...
var view = function view(state, actions) {
  ...
  return (0, _hyperapp.h)(
    ...
    (0, _hyperapp.h)(
      "button",
      { type: "button", onclick: actions.startVideo },
      "\u30D3\u30C7\u30AA\u30AD\u30E3\u30D7\u30C1\u30E3\u958B\u59CB"
    ),
    (0, _hyperapp.h)(
      "button",
...
},{"babel-runtime/regenerator":14,"hyperapp":12,"./style.css":6}],20:[function(require,module,exports) {
